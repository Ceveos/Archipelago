...
from .Items import item_table, PlateUpItem
from .Locations import location_table, PlateUpLocation
...
class PlateUpWorld(World):
    """ 
     PlateUp! combines chaotic kitchen and restaurant management with strategic planning and development to create a
     delightful roguelite dish unlike any other.
    ...
    def generate_output(self, output_directory: str):
        ...
        filename = f"{self.multiworld.get_out_file_name_base(self.player)}.applateup"
